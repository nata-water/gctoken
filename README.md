...
```bash
npx github:nata-water/gctoken

# オプション
npx github:nata-water/gctoken --today          # 今日のみ
npx github:nata-water/gctoken --month --models  # 今月 + モデル別
npx github:nata-water/gctoken --days 7 --json   # 直近7日をJSON出力
```
